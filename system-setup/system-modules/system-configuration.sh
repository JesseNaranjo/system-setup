...
configure_tmux() {
    ...
    add_config_if_needed "tmux" "$config_file" "set -g pane-border-format" '"#{?pane_active,#[fg=#ff0051]#[bg=#4aa244]  ●#[fg=#000000],#[fg=#333333]#[bg=#999999]  ○} #{pane_title}  //  #{pane_current_command} "' "pane border format"
