...
configure_tmux() {
    ...
    add_config_if_needed "tmux" "$config_file" "set -g pane-border-format" '"#{?pane_active,#[fg=#ff0051]#[bg=#4aa244]  ●#[fg=#ffffff],#[fg=#ffffff]#[bg=#58695d]  ○} #{pane_title}  //  #{pane_current_command} "' "pane border format"
