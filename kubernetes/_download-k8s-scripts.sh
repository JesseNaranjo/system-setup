...
# Check for updates to _download-k8s-scripts.sh itself
# This function only updates the main script and will restart if updated
self_update() {
    local SCRIPT_FILE="_download-k8s-scripts.sh"
...
update_modules() {
    ...
    print_info "Checking for Kubernetes script updates..."
    echo ""
    ...
    echo ""
    echo "============================================================================"
    print_info "Kubernetes Script Update Summary"
    echo "============================================================================"
