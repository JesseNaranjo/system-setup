...
# _download-utils-scripts.sh - utils Script Management and Auto-Updater
#
# Usage: ./_download-utils-scripts.sh
#
# This script:
# - Self-updates from the remote repository before running
# - Downloads the latest versions of all utils management scripts
...
# List of script files to download/update (excludes _download-utils-scripts.sh and utils-misc.sh)
get_script_list() {
    echo "dig-all.sh"
...
update_modules() {
    ...
    print_info "Checking for utils script updates..."
    echo ""
    ...
    echo ""
    echo "============================================================================"
    print_info "utils Script Update Summary"
    echo "============================================================================"
